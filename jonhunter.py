#CNA 330 2nd quarter
# work with groups and Gabe AND Samuel Lian
...
def add_new_job(cursor, jobdetails):
    ...
    Newquery = cursor.execute("INSERT INTO Jobs(Type, "
                              "Title, Description, "
                              "Job_id, Created_at, "
                              "Company, Location, "
                              "How_to_apply" ") "
                              "VALUES(%s,%s,%s,%s,%s,%s,%s,%s)", (
                              type, title, description, job_id, created_at, company, location,
                              how_to_apply))  # The Sources code come from https https://stackoverflow.com/questions/20818155/not-all-parameters-were-used-in-the-sql-statement-python-mysql/20818201#20818201
